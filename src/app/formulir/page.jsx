  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (hasil.success) {
        ...
        // Mengubah state ke true untuk memicu tampilan halaman website mereka yang sudah jadi
        setSubmitted(true);
      } else {
    ...
    <div className={styles.container}>
      <main className={styles.mainContent}>
        ...
        {!submitted ? (
          ...
          /* HALAMAN AKHIR: JIKA FORMULIR SUDAH DIKIRIM (MENAMPILKAN PREVIEW LINK WEBSITE MEREKA) */
