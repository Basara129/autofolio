...
export default function ProfilForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    foto: null,
    biografi: '',
    design: 'model_1', // 👈 Tambah properti design bawaan awal
    instagram: '',
    tiktok: '',
    X: '',
    linkedin: ''
  ...
  const handleSubmit = async (e) => {
    ...
    dataToSend.append('design', formData.design); // 👈 Kirimkan model desain terpilih ke API
    ...
    try {
      ...
      if (hasil.success) {
        ...
        setFormData({
          ...
          foto: null,
          biografi: '',
          design: 'model_1', // 👈 Kembalikan ke pilihan default
          instagram: '',
          tiktok: '',
          X: '',
          linkedin: ''
    ...
    <div className={styles.container}>
      <main className={styles.mainContent}>
        ...
        <form onSubmit={handleSubmit} className={styles.formContainer}>
          ...
          {/* 👇 ELEMEN BARU: PILIHAN DESIGN TEMPLATE (Diletakkan strategis sebelum upload foto) */}
          <div className={styles.formGroup}>
